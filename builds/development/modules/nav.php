<!-- REGISTER BAR -->
  <div class="topspace">
    <!-- <p><i class="fa fa-lock" aria-hidden="true"></i> <a href="#"> Login / Register </a></p><span id="divider"> | </span> -->

    <!- Programmatically dial the phone? -->
...
<!-- LOGO AREA -->
  <div class="logo-area">
    <a href="index.php">
      <img src="img/splogo.png" alt="">
    </a>
  </div>

<!-- NAVBAR -->
    <nav id="nav" class="navbar navbar-toggleable-md navbar-light fixed-top">
      <button id="pin1" class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
...
<!-- nav items -->
          <li class="nav-item dropdown active">
            <!- Menu names are rather long -->
            <a class="nav-link dropdown-toggle" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Neighborhoods</a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="community.php">Community</a>
              <a class="dropdown-item" href="community.php#estuary">The Estuary</a>
              <a class="dropdown-item" href="community.php#island">The Island</a>
              <a class="dropdown-item" href="community.php#woodlands">Woodlands</a>
              <a class="dropdown-item" href="community.php#eagles">Eagles Preserve</a>
              <a class="dropdown-item" href="community.php#plans">Floor Plans</a>
              <a class="dropdown-item" href="community.php#pricing">Pricing</a>
              <a class="dropdown-item" href="community.php#testimonials">Testimonials</a>
              <a class="dropdown-item" href="community.php#tours">Tours</a>
            </div>
          </li>
          ...
          <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown02">
              ...
              <a class="dropdown-item" href="lifestyles.php#recreation">Recreation</a>
            </div>
          </li>
          ...
          <li class="nav-item dropdown ">
            <a class="nav-link dropdown-toggle" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Healthcare</a>
            <div class="dropdown-menu" aria-labelledby="dropdown04">
              <a class="dropdown-item" href="healthcare.php#healthcare">Comprehensive Healthcare</a>
              <a class="dropdown-item" href="healthcare.php#assisted">Assisted Living</a>
              <a class="dropdown-item" href="healthcare.php#nursing">Skilled Nursing</a>
